...
var pager = {
	...
	generPageHtml : function(currentPage){
		...
		if(hasPrv){
			str_goFirst = '<a class="goFirst" onclick="pager.search(1);"><img src="../../jslib/newPaging/uploadImages/goFirstImg_A.png"/></a>';
			str_prv = '<a href="javascript:void(0);" onclick="pager.search('+prv+');" title="上页">上页</a>';
		}else{
			str_goFirst = '<span class="goFirst"><img src="../../jslib/newPaging/uploadImages/goFirstImg_X.png"/></span>';
			str_prv = '<span class="disabled">上页</span>';
		}
		
		if(hasNext){
			str_goFinal = '<a class="goFirst" onclick="pager.search('+this.totalPage+');"><img src="../../jslib/newPaging/uploadImages/goFinalImg_A.png"/></a>';
			str_next = '<a href="javascript:void(0);" onclick="pager.search('+next+');" title="下页">下页</a>';
		}else{
			str_goFinal = '<span class="goFirst"><img src="../../jslib/newPaging/uploadImages/goFinalImg_X.png"/></span>';
	...
	search: function(currentPage) {
		...
		$.ajax({
            ...
            success : function(result) {
				...
				pager.totalPage = parseInt($("#"+pager.resultId+" #totalPage").val());// 获取总页数
				//生成分页控件Html
...
var jBoxPager = {
	...
	generPageHtml : function(currentPage){
		...
		var str_prv = '', str_next = '', str_goFirst = '', str_goFinal = '';
		if(hasPrv){
			str_goFirst = '<a class="goFirst" onclick="jBoxPager.search(1);"><img src="../../jslib/newPaging/uploadImages/goFirstImg_A.png"/></a>';
		...
		if(hasNext){
			str_goFinal = '<a class="goFirst" onclick="jBoxPager.search('+this.totalPage+');"><img src="../../jslib/newPaging/uploadImages/goFinalImg_A.png"/></a>';
	...
	search: function(currentPage) {
		...
		$.ajax({
            ...
            success : function(result) {
				...
				jBoxPager.totalPage = parseInt($(jBoxPager.jBoxId + "#"+jBoxPager.resultId+" #totalPage").val());// 获取总页数
				//生成分页控件Html
...
var showPageList;
//前台分页 使用方法，引用../../jslib/newPaging/newPaging.css, 
//					../../jslib/newPaging/paging.js ,
...
function pagingColumnByForegroundNew(divId,showList,pageSize){
	...
	pageDiv += " <a class='goFirst' id='pagingColumnFirstPage"+divId+"' title='首页' ><img src='../../jslib/newPaging/uploadImages/goFirstImg_A.png'/></a>";
	...
	pageDiv += " <a class='goFirst' id='pagingColumnLastPage"+divId+"' title='末页' ><img src='../../jslib/newPaging/uploadImages/goFinalImg_A.png'/></a>";
